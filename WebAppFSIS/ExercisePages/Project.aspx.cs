    ...
    public partial class Project : System.Web.UI.Page
    {
        ...
        protected void SearchEmployeesPartial_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    EmployeesController sysmgr = new EmployeesController();
                    List<Employee> info = sysmgr.FindByPartialName(PartialEmployeeNameV2.Text);
                    if (info.Count == 0)
                    {
        ...
        protected void List02_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string productid = (agvrow.FindControl("FullName") as Label).Text;
